	...
	<footer class="bg-black">
		...
		>
			<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
				...
				<div
					class="grid justify-items-centr lg:justify-items-end grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-2 lg:col-span-2"
				>
					<div class="text-center sm:text-left">
						<NuxtLink class="text-lg font-medium text-gray-900 dark:text-white">
							{{ $t('footer.nav') }}
						</NuxtLink>
					...
					<div class="text-center sm:text-left">
						...
						<ul class="mt-8 space-y-4 text-sm">
							...
							>
								...
								<address
									class="-mt-0.5 flex-1 text-gray-700 not-italic dark:text-gray-300"
								>
									{{ $t('footer.address') }}
								</address>
							</li>
			...
			<div class="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
				<div class="text-center sm:flex sm:justify-between sm:text-left">
					<p class="text-sm text-gray-500 dark:text-gray-400">
						...
						<a
							class="inline-block text-sky-500 underline transition hover:text-sky-700"
							href="#"
						>
							Terms & Conditions
						</a>
					...
					<p
						class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0 dark:text-gray-400"
					>
						&copy; 2025
					</p>
				</div>
